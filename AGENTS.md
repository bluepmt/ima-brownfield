# AGENTS.md — IMA Brownfield Project
...
This project is indexed by GitNexus as **ima-brownfield** (55 symbols, 74 relationships, 1 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
3. `READ gitnexus://repo/ima-brownfield/process/{processName}` — trace the full execution flow step by step
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ima-brownfield/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ima-brownfield/clusters` | All functional areas |
| `gitnexus://repo/ima-brownfield/processes` | All execution flows |
| `gitnexus://repo/ima-brownfield/process/{name}` | Step-by-step execution trace |
