(function () {
  ...
  var INDEX = [
    ...
    { id:'08', title:'Tender Brain Search', url:'08. Tender Brain Search.html', items:[
      { s:'Knowledge Graph', t:'Interactive map of project contracts, exhibits, work packages, technical documents and references' },
      { s:'Document Search', t:'Full-text search across tender package, contract clauses, technical specifications, schedules' },
      { s:'Work Package Nodes', t:'WP1–WP10 detailed breakdown with connections to related contracts and specifications' },
      { s:'Topic & Reference Search', t:'Keywords: SIMOPS, Nigerian Content, ICSS, FOC, P&ID, Commissioning, Security, Logistics' },
      { s:'Clarifications & Bulletins', t:'Technical clarifications, addenda, site bulletins, design revisions tracking' }
    ]}
  ];
  ...
  styleEl.textContent = [
    ...
    '.ima-search-sep{width:1px;height:18px;background:rgba(202,238,251,0.18);flex-shrink:0;margin:0 8px 0 4px;}',
    '.ima-search-trigger{display:inline-flex;align-items:center;gap:8px;margin-left:auto;background:rgba(202,238,251,0.07);border:1px solid rgba(202,238,251,0.2);border-radius:5px;color:rgba(202,238,251,0.6);padding:5px 12px 5px 10px;font-size:10.5px;font-family:Georgia,serif;cursor:pointer;transition:all 0.18s;white-space:nowrap;min-width:172px;letter-spacing:0.01em;}',
    '.ima-search-trigger:hover{background:rgba(202,238,251,0.13);border-color:rgba(202,238,251,0.35);color:rgba(202,238,251,0.9);}',
    '.ima-search-trigger:hover .ima-search-icon{opacity:0.9;}',
    '.ima-search-icon{flex-shrink:0;opacity:0.55;transition:opacity 0.18s;}',
    '.ima-search-placeholder{flex:1;font-style:italic;font-size:10.5px;text-align:left;}',
    '.ima-search-trigger kbd{font-size:8.5px;background:rgba(202,238,251,0.1);border:1px solid rgba(202,238,251,0.2);border-radius:3px;padding:1px 5px;font-family:monospace;color:rgba(202,238,251,0.45);letter-spacing:0;flex-shrink:0;}',
